...
public class LevelLoop extends ALevel {
    com.siminenko.falldown.Model.Infinite.Score score;
    Random random;
    ...
    public LevelLoop() {
        ...
        this.blockTime = 3000;
        this.clockTime = 3000;
        score = new com.siminenko.falldown.Model.Infinite.Score();
        com.siminenko.falldown.Model.Infinite.Score.score = 0;
        random = new Random();
    }

    public static void initStatic() {
        com.siminenko.falldown.Model.Infinite.Score.init();
    }

    @Override
    public void afterInit() {
        super.afterInit();
        com.siminenko.falldown.Layout.GameLayout.world.setGravity(new Vector2(0, -9f));
    }
    ...
    public void act() {
        ...
        if (time % 3600 == 0) {
            ...
            com.siminenko.falldown.Layout.GameLayout.world.setGravity(new Vector2(0, com.siminenko.falldown.Layout.GameLayout.world.getGravity().y - 1));
        }
        ...
        if (this.aScenarioVector2.size() == 0) {
            ...
            if (this.kinematicCount() == 0 && result <= this.kinematicScenarioChance) {
                ...
                Vector<com.siminenko.falldown.Model.Level.AScenario> scenarios = this.getKinematicScenario();
                ...
                Vector<com.siminenko.falldown.Model.Level.AScenario> scenarios = this.getComplexScenario();
                for (int i = 0; i < scenarios.size(); i++) {
                    this.aScenarioVector2.add(scenarios.get(i));
                }
            } else {
    ...
    public void setBonuses() {
        ...
        if (r > this.bigChance && r < (this.bigChance + this.coinChance)) {
            this.aScenarioVector2.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBonusCoin(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    player,
                    this,
                    0,
    ...
    public Vector<com.siminenko.falldown.Model.Level.AScenario> getKinematicScenario() {
        Vector<com.siminenko.falldown.Model.Level.AScenario> scenarios = new Vector<com.siminenko.falldown.Model.Level.AScenario>();
        int result = random.nextInt(1);
        int time = 200 + random.nextInt(400);
        if (result == 0) {
            scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.KinematicBlockHorizontalMovable(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    player,
                    this,
                    30,
    ...
    public Vector<com.siminenko.falldown.Model.Level.AScenario> getComplexScenario() {
        Vector<com.siminenko.falldown.Model.Level.AScenario> scenarios = new Vector<com.siminenko.falldown.Model.Level.AScenario>();
        ...
        if (result == 0) {
            ...
            for (int j = 0; j < 15; j++) {
                scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockCircle(
                        com.siminenko.falldown.Layout.GameLayout.world,
                        player,
                        this,
            ...
            scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockBig(com.siminenko.falldown.Layout.GameLayout.world, this.player, this, this.getComplexScenarioDelay(), 0));
            for (int i = 0; i < 25; i++) {
                scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockCircle(
                        com.siminenko.falldown.Layout.GameLayout.world,
                        this.player,
            ...
            for (int i = 0; i < 20; i++) {
                scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockX(
                        com.siminenko.falldown.Layout.GameLayout.world,
                        player,
                        this,
            ...
            for (int i = 0; i < 5; i++) {
                for (int j = 0; j < 6; j++) {
                    scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockVertical(
                            com.siminenko.falldown.Layout.GameLayout.world,
                            this.player,
                            this,
                            j == 0 ? 90 : 0,
            ...
            for (int j = 0; j < 2; j++) {
                for (int i = -3; i < 3; i++) {
                    scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockHorizontal(
                            com.siminenko.falldown.Layout.GameLayout.world,
                            this.player,
                            this,
                            i == -3 ? 120 : 5,
            ...
            for (int i = 0; i < 10; i++) {
                scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBonusCoin(
                        com.siminenko.falldown.Layout.GameLayout.world,
                        player,
                        this,
                        i == 0 ? 120 : 8,
            ...
            for (int i = 0; i < 8; i ++) {
                scenarios.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockBig(com.siminenko.falldown.Layout.GameLayout.world, this.player, this, i == 0 ? 140 : 30, 0));
            }
        } else if (result == 10) {
    ...
    public com.siminenko.falldown.Model.Level.AScenario getSimpleScenario() {
        int result = random.nextInt(5);
        com.siminenko.falldown.Model.Level.AScenario aScenario = null;

        if (result == 0) {
            aScenario = new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockCircle(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    player,
                    this,
            ...
            aScenario = new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockX(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    player,
                    this,
                    new Vector2(random.nextInt(20) - 10 + MyGdxGame.width / 2, MyGdxGame.height + 10),
            ...
            aScenario = new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockCircleDestroyable(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    player,
                    this,
                    this.getSimpleScenarioDelay(),
            ...
            aScenario = new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockCircleBomb(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    player,
                    this,
                    this.getSimpleScenarioDelay(),
            ...
            aScenario = new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockHorizontal(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    this.player,
                    this,
                    this.getSimpleScenarioDelay(),
