...
public class Level20 extends com.siminenko.falldown.Model.Level.ALevel {
    ...
    public void init() {
        ...
        for (int i = 0; i < 8; i ++) {
            this.aScenarioVector2.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockX(
                    ...
                    player,
                    this,
                    new Vector2(MyGdxGame.width / 2 , MyGdxGame.height + 11),
                    new Vector2(0, -15),
                    i == 0 ? 100 : 40 + i * 3,
                    0,
                    random.nextInt(10),
        ...
        for (int i = 0; i < 10; i++) {
            this.aScenarioVector2.add(new com.siminenko.falldown.Model.Level.Scenarious.General.SimpleBlockBig(
                    com.siminenko.falldown.Layout.GameLayout.world,
                    player,
                    this,
                    i == 0 ? 180 : 30,
