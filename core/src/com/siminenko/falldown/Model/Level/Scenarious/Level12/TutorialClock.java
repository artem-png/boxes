package com.siminenko.falldown.Model.Level.Scenarious.Level12;
...
public class TutorialClock extends com.siminenko.falldown.Model.Level.AScenario {
    Sprite clicker;
    ...
    public TutorialClock(World world, com.siminenko.falldown.Model.Player player, ALevel level, int delay) {
        this.level = level;
        this.world = world;
        this.player = player;
        this.doDelay = 100;
