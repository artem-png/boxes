...
public class Particles {
    Vector<com.siminenko.falldown.Model.Particle> particleCircle = new Vector<com.siminenko.falldown.Model.Particle>();
    Vector<com.siminenko.falldown.Model.Particle> particleTriangle = new Vector<com.siminenko.falldown.Model.Particle>();
    Vector<com.siminenko.falldown.Model.Particle> particleSquare = new Vector<com.siminenko.falldown.Model.Particle>();
    ...
    public void act() {
        ...
        if (timeout < 0) {
            ...
            if (particleCircle.size() + particleTriangle.size() + particleSquare.size() < maxParticles) {
                ...
                if (result == 0) {
                    particleSquare.add(new com.siminenko.falldown.Model.Particle(Tex.rectangle1));
                }
                if (result == 1) {
                    particleCircle.add(new com.siminenko.falldown.Model.Particle(Tex.circle1));
                }
                if (result == 2) {
                    particleTriangle.add(new com.siminenko.falldown.Model.Particle(Tex.triangle1));
                }
            }
        }
    }
