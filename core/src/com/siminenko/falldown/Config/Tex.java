...
public class Tex {
    ...
    public static void createParticles(int count, float sizeMulti, Vector2 position) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            com.siminenko.falldown.Layout.GameLayout.effects.effects.add(new com.siminenko.falldown.Model.EffectSquare(
    ...
    public static com.siminenko.falldown.Model.EffectSquare getParticle(float sizeMulti, Vector2 position, int time) {
        Random random = new Random();
        float sizeF = (random.nextInt(10) + 4) / 13f * sizeMulti;
        com.siminenko.falldown.Model.EffectSquare effectSquare = new com.siminenko.falldown.Model.EffectSquare(
                new Vector2(position),
                new Vector2(sizeF, sizeF),
                new Vector2(random.nextFloat() / 3.5f * Tex.negativeOrPositive(), random.nextFloat() / 3.5f * Tex.negativeOrPositive()),
                new Color(random.nextFloat(), random.nextFloat(), random.nextFloat(), 1),
