...
public class ObstacleX extends AObject implements Destroyable {
    ...
    public void act() {
        ...
        if (isDestroyed && ! isDisposed) {
            ...
            com.lisuart.falldown.Model.ObstaclePanel obstaclePanel = new com.lisuart.falldown.Model.ObstaclePanel(
                    this.world,
            ...
            obstaclePanel = new com.lisuart.falldown.Model.ObstaclePanel(
                    this.world,
                    new Vector2(this.body.getPosition()),
                    new Vector2(this.body.getLinearVelocity()),
                    this.body.getAngle(),
            ...
            obstaclePanel.body.setActive(true);
            GameLayout.level.aObjectVector2.add(obstaclePanel);
            com.lisuart.falldown.Config.Tex.createParticles(8, 1, this.body.getPosition());
        }
    }
    ...
    public void render(SpriteBatch batch) {
        ...
        if (type == ObstacleX.TYPE_DESTROYABLE) {
            s = com.lisuart.falldown.Config.Tex.crestDestroyable;
        } else {
            s = com.lisuart.falldown.Config.Tex.crest1;
        }
        batch.draw(
                s,
                ...
                6f * sizeMultiplier,
                6 * sizeMultiplier,
                com.lisuart.falldown.Config.Tex.crest1.getScaleX(),
                com.lisuart.falldown.Config.Tex.crest1.getScaleY(),
