...
public class PlayButton {
        ...
        if (isPressed) {
            ...
            if (Gdx.input.justTouched()) {
                ...
                if (vector3.x > com.lisuart.falldown.MyGdxGame.width / 2 - size.x / 2 && vector3.x < com.lisuart.falldown.MyGdxGame.width / 2 + size.x / 2) {
                    if (vector3.y > com.lisuart.falldown.MyGdxGame.height / 2 - 12 - size.y / 2 && vector3.y < com.lisuart.falldown.MyGdxGame.height / 2 - 12 + size.y / 2) {
                        isPressed = true;
    ...
    public void render(SpriteBatch batch) {
        batch.draw(
                ...
                com.lisuart.falldown.MyGdxGame.height / 2 - 7 - size.y / 2 - 5,
                size.x,
                size.y
        );
        batch.end();
        ...
        font.draw(
                ...
                "PLAY",
                com.lisuart.falldown.Config.Tex.x * 388,
                com.lisuart.falldown.Config.Tex.y * 174
        );
