...
public class ObstacleCircleBomb extends AObject {
    ...
    public void explosionTime() {
        expTime -= 1 * ((float) com.lisuart.falldown.Layout.GameLayout.speedSetting / (float) com.lisuart.falldown.Layout.GameLayout.speed);
        if (expTime <= 0 && !isExplosionComplete) {
            ...
            com.lisuart.falldown.Config.Tex.createParticles((int)(count * 1.5f), 1, body.getPosition());
            this.body.setActive(false);
            this.body.setTransform(-100, -300, 0);
            com.lisuart.falldown.Model.Music.Music.boom();
        }
    }
    ...
    public void render(SpriteBatch batch) {
        ...
        batch.draw(
                com.lisuart.falldown.Config.Tex.circle1,
                ...
                size,
                size,
                com.lisuart.falldown.Config.Tex.circle1.getScaleX(),
                com.lisuart.falldown.Config.Tex.circle1.getScaleY(),
