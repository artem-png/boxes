...
public class TutorialMove extends AScenario {
    ...
    Vector2 firstPositionSetting = new Vector2(com.lisuart.falldown.MyGdxGame.width / 2, 20);
    Vector2 firstPosition = new Vector2(com.lisuart.falldown.MyGdxGame.width / 2, 20);
    ...
    public TutorialMove(World world, Player player, ALevel level, int delay) {
        ...
        tplayer = new TutorialSprite(com.lisuart.falldown.Config.Tex.player1, new Vector2(1, 49), new Vector2(9, 9));
        tplus = new TutorialSprite(plus, new Vector2(12, 52), new Vector2(3, 3));
        tblock = new TutorialSprite(com.lisuart.falldown.Config.Tex.rectangle1, new Vector2(20.5f, 50), new Vector2(2, 7));
    ...
    public void act() {
        ...
        if (!isClicked) {
            ...
            if (firstPosition.x > com.lisuart.falldown.MyGdxGame.width - 10) {
                goLeft = true;
            }
            goDuration--;
            if (goDuration <= 0) {
