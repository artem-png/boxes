...
public class Particle {
    ...
    public Particle(Sprite sprite) {
        ...
        position = new Vector2(random.nextInt(com.lisuart.falldown.MyGdxGame.width), random.nextInt(com.lisuart.falldown.MyGdxGame.height));
        alpha = 0.0f;
        rotation = 0;
    ...
    public boolean isDead() {
        if (position.x > com.lisuart.falldown.MyGdxGame.width + 5 || position.x < -5 || position.y > com.lisuart.falldown.MyGdxGame.height + 5 || position.y < -5) {
            return true;
        }
        return duration < 0;
    }
