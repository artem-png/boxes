...
public class Background {
    ...
    Vector2 sprite2Position = new Vector2(-5, com.lisuart.falldown.MyGdxGame.height);
    ...
    public void render(SpriteBatch batch) {
        batch.draw(sprite1, sprite1Position.x, sprite1Position.y, com.lisuart.falldown.MyGdxGame.width + 10, com.lisuart.falldown.MyGdxGame.height + 2);
        batch.draw(sprite2, sprite2Position.x, sprite2Position.y, com.lisuart.falldown.MyGdxGame.width + 10, com.lisuart.falldown.MyGdxGame.height + 2);
    }
    ...
    public void act() {
        ...
        if (sprite1Position.y < -com.lisuart.falldown.MyGdxGame.height) {
            sprite1.getTexture().dispose();
            sa = sb2;
            sb = this.getNewNumber(sa);
            sprite1 = getSprite(sa, sb);
            sprite1Position.y = com.lisuart.falldown.MyGdxGame.height;
        } else if (sprite2Position.y < -com.lisuart.falldown.MyGdxGame.height) {
            sprite2.getTexture().dispose();
            sa2 = sb;
            sb2 = this.getNewNumber(sa2);
            this.sprite2 = getSprite(sa2, sb2);
            sprite2Position.y = com.lisuart.falldown.MyGdxGame.height;
        }
    }
